...
namespace BezierSolution
{
    ...
    public class BezierSpline : MonoBehaviour
    {
        ...
        public void createSpline()
        {
            ...
            //track = GameOject.FindWithTag("Track");
            //GameObject leftRail = (GameObject)R 

            //vr.BuildRollercoasterTrack(track, spline, leftRailPrefab, rightRailPrefab, crossBeamPrefab, resolution);
    ...
    public BezierPoint InsertNewPointAt2(int index, Vector3 pointPosition)
    {
        //	if (index < 0 || index > endPoints.Count)
        //{
        //	Debug.LogError("Index " + index + " is out of range: [0," + endPoints.Count + "]");
        ...
        int prevCount = endPoints.Count;    // Index do último ponto inserido

        BezierPoint point = new GameObject("Point" + index).AddComponent<BezierPoint>();    // Adicionar novo ponto à pista
